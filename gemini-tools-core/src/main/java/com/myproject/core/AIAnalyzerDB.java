...
/**
 * AIAnalyzerDB: Corrige y analiza archivos usando la API Gemini (v1beta).
...
public class AIAnalyzerDB {
    ...
    public String analyze(String context, String fileToFix) throws IOException {
        ...
        String systemInstruction =
            "Actúa como un Ingeniero/Administrador de Bases de Datos (DBA) experimentado. Firma tu respuesta con tu rol, fecha y hora. Analiza el contexto completo del proyecto y el archivo proporcionado, enfocándote en el diseño del esquema, la optimización de consultas (queries), la integridad y el rendimiento de la base de datos (SQL/NoSQL), para encontrar y aplicar las correcciones necesarias. Tu respuesta DEBE ser SOLAMENTE el código completo corregido, sin explicaciones ni bloques de marcado.";
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 2) {
            System.out.println("Uso: java -cp <classpath> com.myproject.core.AIAnalyzerDB <contexto.txt> <archivo.java>");
        ...
        AIAnalyzerDB analyzer = new AIAnalyzerDB();
        try {
